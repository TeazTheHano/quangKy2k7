...
const Home = () => {
    ...
    const [setsHaveRepeatToday, setSetsHaveRepeatToday] = useState<SetFormat[]>([]);
    ...
    return (
        <SSBar trans barContentStyle='light-content' bgColor={clrStyle.black}>
